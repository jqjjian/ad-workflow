...
import { Button, Card, Spin, message, Image } from 'antd'
            ...
            {result?.success && result?.data && (
                <div className="mt-6 rounded border border-green-200 bg-green-50 p-4">
                    ...
                    <div className="mt-2">
                        ...
                        <ul className="mt-1 max-h-[300px] overflow-y-auto pr-2">
                            {files.map((file, index) => {
                                // 检查文件是否为图片类型
                                const isImage =
                                    file.fileType &&
                                    /^image\/(jpeg|jpg|png|gif|webp|bmp)$/i.test(
                                        file.fileType
                                    )
                                ...
                                return (
                                    <li key={index} className="mb-3 text-sm">
                                        ...
                                        {isImage && (
                                            <div className="mt-2">
                                                <div className="inline-block overflow-hidden rounded border border-gray-200 shadow-sm">
                                                    <Image
                                                        src={file.fileUrl}
                                                        alt={file.fileName}
                                                        style={{
                                                        ...
                                                        placeholder={
                                                            <div className="flex h-[100px] w-[150px] items-center justify-center bg-gray-100">
                                                                加载中...
                                                            </div>
                                                        }
                                                    />
